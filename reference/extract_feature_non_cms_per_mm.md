...
Extract scaled number of consecutively non-matching striation marks from
two aligned signatures

## Usage

``` r
extract_feature_non_cms_per_mm(striae, aligned, resolution)
```
...
scaled number of consecutively non-matching striation marks
