...
scores, i.e. if a bullet has six lands, each of the input vectors should
have length 36.
...
- addNA:
  ...
  logical value. In case of missing lands, are scores set to 0 (addNA =
  FALSE) or set to NA (addNA = TRUE)
