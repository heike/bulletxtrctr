...
Extract scaled number of consecutively matching elevated striation marks
from two aligned signatures

## Usage

``` r
extract_feature_cms2_per_mm(striae, aligned, resolution)
```
...
scaled number of consecutively matching elevated striation marks per
millimeter
