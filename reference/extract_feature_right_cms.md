...
Extract number of consecutively matching elevated striation marks from
the right of two aligned signatures

## Usage

``` r
extract_feature_right_cms(striae)
```
...
number of consecutively matching striation marks (from right)
